...
1	Апартаменты «Metro Plus»	appartment	Уютная студия в центре города. Современный ремонт, вся необходимая техника, Wi-Fi. Рядом метро и остановки общественного транспорта.	2500.00	t	Москва, ул. Тверская, д. 15	Москва	../img/property/metro-plus.png
...
3	Комната в квартире	room	Уютная комната в центре Москвы. Общая кухня и ванная. Отличный вариант для бюджетного проживания.	1200.00	t	Москва, ул. Арбат, д. 25	Москва	../img/property/komnata-arbat.jpg
...
5	Студия «City Center»	appartment	Современная студия в деловом центре. Панорамные окна, вид на город. Подходит для командировок.	3200.00	t	Москва, Сити, Пресненская наб., д. 10	Москва	../img/property/studia.jpg
