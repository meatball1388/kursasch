        ...
        <div class="d-flex align-items-center gap-4">
            ...
            <div class="dropdown">
                <button
                    class="btn btn-link text-white text-decoration-none dropdown-toggle d-flex align-items-center gap-2"
                    type="button" data-bs-toggle="dropdown">
                    <i class="bi bi-currency-ruble"></i><span>RUB</span></button>
                <ul class="dropdown-menu dropdown-menu-end">
                    <li><a class="dropdown-item" href="#"><i class="bi bi-currency-ruble me-2"></i> RUB</a></li>
                    <li><a class="dropdown-item" href="#"><i class="bi bi-currency-dollar me-2"></i> USD</a></li>
                </ul>
            </div>
            <?php
