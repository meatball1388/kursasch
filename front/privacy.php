        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                <div class="legal-content">
                    ...
                    <h1 id="rules">Правила бронирования и Оферта</h1>
                    <p class="text-muted small mb-4">Редакция от 1 июня 2026 года</p>

                    <h2>1. Порядок бронирования и оплаты</h2>
                    <p>Бронирование объектов на BRONIC.RU осуществляется в режиме реального времени. Процесс считается завершенным после успешного прохождения транзакции через платежный шлюз.</p>
                    <ul>
                        <li><strong>Предоплата:</strong> Для гарантированного бронирования требуется внесение полной стоимости проживания и дополнительных сборов.</li>
                        <li><strong>Безопасность:</strong> Все платежи защищены протоколом SSL и обрабатываются сертифицированной системой ЮKassa.</li>
                    </ul>

                    <h2>2. Правила заезда и проживания</h2>
                    <ul>
                        <li><strong>Время заезда:</strong> Стандартное время заезда — с 14:00 по местному времени.</li>
                        <li><strong>Время выезда:</strong> Расчетный час — до 12:00 по местному времени.</li>
                        <li><strong>Документы:</strong> При заезде гость обязан предоставить документ, удостоверяющий личность (паспорт РФ).</li>
                    </ul>

                    <h2>3. Условия отмены и возврата</h2>
                    <p>Мы понимаем, что планы могут измениться, поэтому предусмотрели гибкую систему отмены:</p>
                    <ul>
                        <li><strong>Бесплатная отмена:</strong> Возможна не позднее чем за 24 часа до заезда.</li>
                        <li><strong>Поздняя отмена:</strong> При отмене менее чем за 24 часа удерживается стоимость первой ночи проживания в качестве компенсации собственнику.</li>
                        <li><strong>Возврат средств:</strong> Денежные средства возвращаются на ту же карту, с которой была произведена оплата, в течение 5-10 банковских дней.</li>
                    </ul>

                    <h2>4. Права и обязанности сторон</h2>
                    <p>Сервис BRONIC.RU является платформой-агрегатором. Мы гарантируем передачу ваших данных и оплаты собственнику жилья, а также поддержку в случае возникновения спорных ситуаций. Гость несет материальную ответственность за сохранность имущества в объекте проживания.</p>
