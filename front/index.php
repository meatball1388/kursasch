                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $.each(response.results, function (index, item) {
                            ...
                            var ratingVal = item.avg_rating > 0 ? parseFloat(item.avg_rating).toFixed(1) : '—';
                            var ratingDisplay = item.avg_rating > 0 ? ratingVal : '4.8';
                            var reviewLabel = reviewCount > 0 ? '(' + reviewCount + ' отзывов)' : 'Новинка';
                                    ...
                                    <div class="property-card card border-0 shadow-sm" style="cursor:pointer;" data-prop-id="${item.id}">
                                        <div class="row g-0">
                                            <div class="col-md-4 position-relative">
                                                <img src="${imgUrl}" class="img-fluid rounded-start h-100 w-100 object-fit-cover" alt="${name.replace(/"/g, '&quot;')}" style="min-height: 200px;" onerror="this.src='../img/property/metro-plus.png'">
                                                <button class="btn btn-favorite position-absolute top-0 end-0 m-3 border-0" title="Добавить в избранное" data-item="${itemJson}"><i class="bi ${heartClass}"></i></button>
                                            </div>
                                            <div class="col-md-8">
                                                <div class="card-body p-4">
                                                    <div class="d-flex justify-content-between align-items-start mb-2">
                                                        ...
                                                        <div class="text-end"><div class="fw-bold"><i class="bi bi-star-fill text-warning me-1"></i>${ratingDisplay}</div><small class="text-muted">${reviewLabel}</small></div>
                                                    </div>
                                                    <hr>
